...
function bringCity(cityName) {
    ...
    for (var i =0; i < codes.length; i++) {
        ...
        if (word.search(cityName) > 0 ) {
            
          //  var start = word.search(cityName);
            
          //  var region = word.slice(0,start - 1);
...
for (var i =0; i < codes.length; i++) {
        ...
        for (var x =0; x< word.length; x++) {
            ...
            if 
            (cityName[cityName.length - 1] == word[word.length - 1] && 
            cityName[cityName.length - 2] == word[word.length - 2] && 
            cityName[cityName.length - 3] == word[word.length - 3] &&
            cityName[cityName.length - 4] == word[word.length - 4] &&
            /*cityName[cityName.length - 5] == word[word.length - 5] && 
            
            cityName[1] == word[end+2])
            
            {
           
            var region = word.slice(0,end)
            alert(region);
            return word;
